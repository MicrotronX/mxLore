...
CREATE TABLE IF NOT EXISTS `agent_messages` (
  ...
  `target_client_key_id` int(11) DEFAULT NULL,
  ...
  KEY `fk_am_target_key` (`target_client_key_id`),
  ...
  CONSTRAINT `fk_am_target_key` FOREIGN KEY (`target_client_key_id`) REFERENCES `client_keys` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
